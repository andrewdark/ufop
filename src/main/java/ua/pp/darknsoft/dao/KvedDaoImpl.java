...
@Service
@Scope(value = "session")
public class KvedDaoImpl implements KvedDao{
    ...
    @Override
    public List<KvedCatalog> getLocationTop(){
        return selectKvedTop.execute();
    }

    @Override
    public List<KvedCatalog> getLocationByTreemark(String treemark, int level){
        Map<String, Object> paramMap = new HashMap<String, Object>();
