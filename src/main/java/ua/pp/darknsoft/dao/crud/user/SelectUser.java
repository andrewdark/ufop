...
public class SelectUser extends MappingSqlQuery{
    private static final String SQL_CHECK_USER="SELECT id,username,pwd,email,contact_link,structure_link FROM user_table WHERE LOWER(username) = LOWER(:username)";
