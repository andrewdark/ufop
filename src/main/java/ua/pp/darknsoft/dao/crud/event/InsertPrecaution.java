...
public class InsertPrecaution extends SqlUpdate{
    private static final String SQL_INSERT_PRECAUTION = "INSERT INTO precaution_table" +
            "(check_event_link,precaution_catalog_link,decision_number,service_date,plan_date,fact_date) " +
            "VALUES(:check_event_link,:precaution_catalog_link,:decision_number,:service_date::DATE ,:plan_date::DATE,:fact_date::DATE)";
    ...
    public InsertPrecaution(DataSource ds) {
        ...
        super.declareParameter(new SqlOutParameter("decision_number",Types.VARCHAR));
