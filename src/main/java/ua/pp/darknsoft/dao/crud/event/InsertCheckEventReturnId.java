...
public class InsertCheckEventReturnId extends SqlUpdate {
    private static final String SQL_INSERT ="INSERT INTO check_event_table (ufop_link,event_number,event_date_begin,event_date_end,check_type,check_violation,event_result,check_sampling,result_sampling,creator_link,structure_catalog_link) " +
            "VALUES (:ufop_link,:event_number,:event_date_begin::DATE ,:event_date_end::DATE,:check_type,:check_violation,:event_result,:check_sampling,:result_sampling,(SELECT id FROM user_table WHERE username = :creator_link),:structure_catalog_link)";
